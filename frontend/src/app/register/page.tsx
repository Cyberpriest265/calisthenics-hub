    ...
    <div style={{
      ...
      <div style={{
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
          ...
          <div className="form-group" style={{ marginBottom: 0 }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 8 }}>
              ...
              <span style={{ fontSize: 12, fontWeight: 500, color: 'var(--text-tertiary)', letterSpacing: '0.2px' }}>
                min. 8 characters
              </span>
            </div>
            <input
        ...
        <p style={{ textAlign: 'center', fontSize: 13, fontWeight: 500, letterSpacing: '0.2px', color: 'var(--med-gray)' }}>
          ...
          <Link href="/login" style={{ color: 'var(--fg)', fontWeight: 600, textDecoration: 'underline', textUnderlineOffset: 3 }}>
            Sign in
          </Link>
        </p>
      </div>
